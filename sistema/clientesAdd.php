			...
			<div class="container-fluid">
				<div class="cadastrar py-3">
					<div class="card shadow">
						...
						<div class="card-body">
							<form method="POST" action="../controller/clientesAdd.php">
								<div class="card mb-4">
										...
										<div class="areaPessoa row">
											...
											<div class="col-12 col-md-3">
												<div class="fisica">
													...
													<div class="input-group mb-4">
														...
														<input id="rgInput" name="rg_cliente" class="form-control" value="" placeholder="Exemplo: 15147386190" type="text">
													</div>
												</div>
												...
												<div class="juridica" style="display: none;">
													...
													<div class="input-group mb-4">
														<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-file-text-o"></i></span></div>
														<input id="ieInput" name="ie_cliente" class="form-control" value="" placeholder="Exemplo: 15147386190" type="text">
													</div>
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												<div class="fisica">
													...
													<div class="input-group mb-4">
														<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-file-text-o"></i></span></div>
														<input id="cpfInput" name="cpf_cliente" class="form-control" value="" placeholder="Exemplo: 15147386190" type="text">
													</div>
												</div>
												...
												<div class="juridica" style="display: none;">
													...
													<div class="input-group mb-4">
														<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-file-text-o"></i></span></div>
														<input id="cnpjInput" name="cnpj_cliente" class="form-control" value="" placeholder="Exemplo: 65622945000190" type="text">
													</div>
												</div>
											</div>
											...
											<div class="col-12 col-md-4">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></div>
													<input id="nomeInput" name="nm_cliente" class="form-control" value="" placeholder="Exemplo: Carlos Vieira" required="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-4">
												...
												<div class="input-group mb-4">
													...
													<input id="nascInput" name="nascimento_cliente" class="form-control" value="" placeholder="Exemplo: 17/02/1998" required="" type="date">
												</div>
											</div>
										...
										<div class="areaContato row">
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													...
													<input id="telInput" name="tel_cliente" class="form-control" value="" placeholder="Exemplo: (11) 3457-5689" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-phone"></i></span></div>
													<input id="telcInput" name="telc_cliente" class="form-control" value="" placeholder="Exemplo: (11) 3457-5689" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													...
													<input id="celInput" name="cel_cliente" class="form-control" value="" placeholder="Exemplo: (11) 95876-5689" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													...
													<input id="emailInput" name="email_cliente" class="form-control" value="" placeholder="Exemplo: (11) 95876-5689" type="text">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="areaEndereco row">
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													...
													<input id="cepInput" name="cep_cliente" class="form-control" value="" placeholder="Exemplo: 02310000" required="" type="text" onkeyup="if(this.value.length >= 8) { $('#ruanrInput').focus(); }">
											...
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-map-marker"></i></span></div>
													<input id="ruaInput" name="rua_cliente" class="form-control" value="" placeholder="Completa ao preencher CEP" required="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-map-marker"></i></span></div>
													<input id="ruanrInput" name="nr_cliente" class="form-control" value="" placeholder="Exemplo: 95" required="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-map-marker"></i></span></div>
													<input id="bairroInput" name="br_cliente" class="form-control" value="" placeholder="Completa ao preencher CEP" required="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-4">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-map-marker"></i></span></div>
													<input id="complInput" name="compl_cliente" class="form-control" value="" placeholder="Exemplo: Casa 2" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-4">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-map-marker"></i></span></div>
													<input id="cidadeInput" name="cid_cliente" class="form-control" value="" placeholder="Completa ao preencher CEP" required="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-4">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-map-marker"></i></span></div>
													<input id="ufInput" name="uf_cliente" class="form-control" value="" placeholder="Completa ao preencher CEP" required="" type="text">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card-body">
										<div class="areaPlano row">
											...
											<div class="col-md-2">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
													<input id="diaVencInput" name="vencimento_cliente" class="form-control" value="" placeholder="Exemplo: 25" required="" type="number">
												</div>
											</div>
											...
											<div class="col-md-2">
												...
												<div class="input-group mb-4">
													<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></div>
													<input id="loginInput" name="login_cliente" class="form-control" value="" placeholder="Exemplo: jose@provedor" required="" type="text">
												</div>
											</div>
											...
											<div class="col-md-2">
												...
												<div class="input-group mb-4">
													...
													<input id="senhaInput" name="pass_cliente" class="form-control" value="" placeholder="Exemplo: 123" required="" type="text">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="areaRede row">
											<div class="col-12 col-md-4">
												<div class="input-group mb-4">
													...
													<input id="ipInput" name="ip_cliente" class="form-control" value="" placeholder="Exemplo: 127.0.0.1" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-4">
												<div class="input-group mb-4">
													...
													<input id="macInput" name="mac_cliente" class="form-control" value="" placeholder="Exemplo: 00:0a:95:9d:68:16" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												<div class="input-group mb-4">
													...
													<input id="radioInput" name="radio_cliente" class="form-control" value="" placeholder="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												<div class="input-group mb-4">
													...
													<input id="repetidoraInput" name="repetidora_cliente" class="form-control" value="" placeholder="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												<div class="input-group mb-4">
													...
													<input id="ctoInput" name="cto_cliente" class="form-control" value="" placeholder="" type="text">
												</div>
											</div>
											...
											<div class="col-12 col-md-3">
												<div class="input-group mb-4">
													...
													<input id="portaInput" name="porta_cliente" class="form-control" value="" placeholder="" type="text">
												</div>
											</div>
										</div>
									</div>
