...
if($_SESSION['FJK_tipo'] == 3) {
	echo "<script>window.location.href = 'chamados.php'; </script>";
}
?>
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-auto text-right">
											<div class="icone-container bg-info text-white rounded-circle float-right">
												<i class="fa fa-wrench"></i>
											</div>
										</div>
									</div>

									<a href="chamados.php" class="mt-3 text-muted text-sm d-block">Ver todos os chamados</a>
								</div>
							</div>
						</div>
						...
						<div class="col-12 col-md-4">
							<div class="card shadow">
								<div class="card-body">
									<div class="row">
										<div class="col">
											<h5 class="card-title text-uppercase text-muted font-weight-normal mb-0">Clientes ativos</h5>
											<span class="h2 font-weight-bold mb-0">
												<?php
									...
									<a href="clientes.php" class="mt-3 text-muted text-sm d-block">Ver todos os clientes</a>
								</div>
							</div>
						</div>
					...
					<div class="card shadow">
						...
						<div class="table-responsive">
							<table class="table table-hover align-items-center table-flush">
								...
								<tbody>
									<?php foreach($chamado->listarChamadosQuantidade(7) as $pro):
									...
									?>
										...
										<tr>
											...
											<td>
												<a href="chamadosImprimir.php?id=<?=$pro['id']?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
